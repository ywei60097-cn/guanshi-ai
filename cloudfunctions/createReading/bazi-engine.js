...
const ELEMENT_DIRECTIONS = { wood: "东", fire: "南", earth: "中", metal: "西", water: "北" };
...
function buildTransit(date = new Date()) {
...
function analyzeChart(chart, transit = buildTransit()) {
...
function createReading(profile, at = new Date()) {
...
function getElementForStem(stem) { return STEMS[stem]?.element; }
